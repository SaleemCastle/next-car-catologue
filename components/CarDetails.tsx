            ...
            <Transition appear show={ isOpen } as={ Fragment }>
                <Dialog as='div' className='relative z-10' onClose={ closeModal }>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        ...
                        >
                            <Dialog.Panel 
                                className='relative w-full p-6 max-w-lg mah-h-[90vh] overflow-y-auto transform rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5'
                            >
                                ...
                                <div className="flex-1 flex flex-col gap-2">
                                    <h2 className='font-semibold text-xl capitalize'>{ make } {  model }</h2>
